...
class ProdukCon extends Controller
{
    ...
    public function update($id)
    {
        ...
        $produk = DB::table('tbproduk')->where('kode', $id)->get();
    ...
    public function storeupdate(Request $request)
    {
        ...
        DB::table('tbproduk')->where('kode', $request->kode)->update([
            'nama' => $request->nama,
            'tipe' => $request->tipe,
            'jenis' => $request->jenis,
            'harga' => $request->harga,
    ...
    {
        // mengambil data produk berdasarkan id yang dipilih
        DB::table('tbproduk')->where('kode', $id)->delete();
        // passing data produk yang didapat ke view edit.blade.php
        return redirect('/produk/tampil');
    }
}
